...
void CAN_Filter_Config(void)
{
    ...
    CAN_Filter_Struct.CAN_FilterNumber = 1;
	...
	CAN_Filter_Struct.CAN_FilterIdHigh = (((uint32_t)0x0200<<3|CAN_ID_STD|CAN_RTR_DATA)&0xFFFF0000) >>16;
	CAN_Filter_Struct.CAN_FilterIdLow =  ((uint32_t)0x0200<<3|CAN_ID_STD|CAN_RTR_DATA)&0x0000FFFF;
	CAN_Filter_Struct.CAN_FilterMaskIdHigh = 0xFFFF;//0xFFFF;//0xFF;
	CAN_Filter_Struct.CAN_FilterMaskIdLow = 0xFFFF;//0xFFFF;//0xFF;	
//    
...
//    CAN_Filter_Struct.CAN_FilterActivation = ENABLE ;
//	
//	CAN_Filter_Struct.CAN_FilterIdHigh = (((uint32_t)0x13141314<<3 | CAN_ID_EXT|CAN_RTR_DATA)&0xFFFF0000) >>16;//000000
//	CAN_Filter_Struct.CAN_FilterIdLow = ((uint32_t)0x13141314<<3|CAN_ID_EXT|CAN_RTR_DATA)&0x0000FFFF;
