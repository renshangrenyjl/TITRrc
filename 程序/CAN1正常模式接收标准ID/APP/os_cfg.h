...
#define OS_CFG_H
                                       ...
                                       /* ---------------------- MISCELLANEOUS ----------------------- */
#define OS_APP_HOOKS_EN           0u   /* Application-defined hooks are called from the uC/OS-II hooks 钩子函数*/
...
#define OS_DEBUG_EN               0u   /* Enable(1) debug variables   调试                                 */

#define OS_EVENT_MULTI_EN         0u   /* Include code for OSEventPendMulti()  多重事件控制                        */
...
#define OS_MAX_EVENTS            80u   /* Max. number of event control blocks in your application最大事件      */
...
#define OS_MAX_TASKS             20u   /* Max. number of tasks in your application, MUST be >= 2   最大任务数量    */
